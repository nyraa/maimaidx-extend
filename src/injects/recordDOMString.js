// required "formatter" object
const recordDOMString = `
const domstring = \`
    <div class="p_10 t_l f_0 v_b">
        ...
        <div class="playlog_$\{record.difficulty}_container">
            <div class="basic_block m_5 $\{record.level ? "m_t_17 m_r_60" : ""} p_5 p_l_10 f_13 break">
                $\{record.level ? \`
                    <div class="w_80 f_r">
...
\`;
`
export default recordDOMString;